...
public class AdminController {
	...
	@RequestMapping({ "", "/" })
	public String adminMain(HttpServletRequest request, Model model, Authentication authentication) {
...
//	    request.getSession().setAttribute("admPrevPage", path);
	...
	@ResponseBody
	public ModaconAjaxList<BoardDTO> admNoticeList(@PathVariable int page, @PathVariable int pageRows) {
	...
	@ResponseBody
	public ModaconAjaxList<BoardDTO> admCommunityList(@PathVariable int page, @PathVariable int pageRows, String type,
			String tag) {
		List<BoardDTO> list = null;
	...
	@ResponseBody
	public ModaconAjaxList<ReportDTO> admReportList(@PathVariable int page, @PathVariable int pageRows) {
	...
	@ResponseBody
	public ModaconAjaxList<MemberVO> admMemberList(@PathVariable int page, @PathVariable int pageRows) {
	...
	@ResponseBody
	public int ChangeMemberAuth(Authentication authentication, @PathVariable int authority,
			@PathVariable int member_uid) {
